...
function glowUp(){
    ...
    setTimeout(()=>  mansfieldTape0.classList.add('hidden'), 21250);
    setTimeout(()=>  mansfieldTape1.classList.add('hidden'), 21500);
    setTimeout(()=>  mansfieldTape2.classList.add('hidden'), 21750);
    setTimeout(()=>  mansfieldTape3.classList.add('hidden'), 22000);
    setTimeout(()=>  mansfieldBackground.classList.add('bg-[#6e6253]'), 22500);
    setTimeout(()=>  mansfieldBackground.classList.remove('bg-gradient-to-br'), 22500);
    setTimeout(()=>  mansfieldBackground.classList.remove('from-amber-50'), 22500);
    setTimeout(()=>  mansfieldBackground.classList.remove('via-amber-100'), 22500);
    setTimeout(()=>  mansfieldBackground.classList.remove('to-amber-50'), 22500);    
    setTimeout(()=>  mansfieldBackground.classList.remove('rotate-[0.3deg]'), 23000);
    setTimeout(()=>  mansfieldBackground.classList.add('shadow-md'), 23000);    
    setTimeout(()=>  mansfieldBackground.classList.add('shadow-gray-700'), 23000);
    setTimeout(()=>  mansfield.classList.remove('saturate-50'), 24000);
    setTimeout(()=>  mansfield.classList.remove('opacity-75'), 24000);
    setTimeout(()=>  mansfield.classList.remove('contrast-60'), 24000);
    setTimeout(()=>  mansfield.classList.add('shadow-inner'), 24000);
    setTimeout(()=>  mansfield.classList.add('shadow-gray-700'), 24000);
    //frame cleveland picture
    setTimeout(()=>  clevelandTape0.classList.add('hidden'), 25250);
    setTimeout(()=>  clevelandTape1.classList.add('hidden'), 25500);
    setTimeout(()=>  clevelandTape2.classList.add('hidden'), 25750);
    setTimeout(()=>  clevelandTape3.classList.add('hidden'), 26000);
    setTimeout(()=>  clevelandBackground.classList.add('bg-[#6e6253]'), 26500);
    setTimeout(()=>  clevelandBackground.classList.remove('bg-gradient-to-br'), 26500);
    setTimeout(()=>  clevelandBackground.classList.remove('from-amber-50'), 26500);
    setTimeout(()=>  clevelandBackground.classList.remove('via-amber-100'), 26500);
    setTimeout(()=>  clevelandBackground.classList.remove('to-amber-50'), 26500);    
    setTimeout(()=>  clevelandBackground.classList.remove('-rotate-[0.5deg]'), 27000);
    setTimeout(()=>  clevelandBackground.classList.add('shadow-md'), 27000);    
    setTimeout(()=>  clevelandBackground.classList.add('shadow-gray-700'), 27000);
    setTimeout(()=>  cleveland.classList.remove('saturate-50'), 28000);
    setTimeout(()=>  cleveland.classList.remove('opacity-75'), 28000);
    setTimeout(()=>  cleveland.classList.remove('contrast-60'), 28000);
    setTimeout(()=>  cleveland.classList.add('shadow-inner'), 28000);
    setTimeout(()=>  cleveland.classList.add('shadow-gray-700'), 28000);
    //frame house picture
    setTimeout(()=>  houseTape0.classList.add('hidden'), 23250);
    setTimeout(()=>  houseTape1.classList.add('hidden'), 23500);
    setTimeout(()=>  houseTape2.classList.add('hidden'), 23750);
    setTimeout(()=>  houseTape3.classList.add('hidden'), 24000);
    setTimeout(()=>  houseBackground.classList.add('bg-[#6e6253]'), 24500);
    setTimeout(()=>  houseBackground.classList.remove('bg-gradient-to-br'), 24500);
    setTimeout(()=>  houseBackground.classList.remove('from-amber-50'), 24500);
    setTimeout(()=>  houseBackground.classList.remove('via-amber-100'), 24500);
    setTimeout(()=>  houseBackground.classList.remove('to-amber-50'), 24500);    
    setTimeout(()=>  houseBackground.classList.remove('-rotate-[-0.5deg]'), 25000);
    setTimeout(()=>  houseBackground.classList.add('shadow-md'), 25000);    
    setTimeout(()=>  houseBackground.classList.add('shadow-gray-700'), 25000);
    setTimeout(()=>  house.classList.remove('saturate-50'), 26000);
    setTimeout(()=>  house.classList.remove('opacity-75'), 26000);
    setTimeout(()=>  house.classList.remove('contrast-50'), 26000);
    setTimeout(()=>  house.classList.add('shadow-inner'), 26000);
    setTimeout(()=>  house.classList.add('shadow-gray-700'), 26000);
    //make services list white board
    setTimeout(()=>  serviceTape0.classList.add('hidden'), 26250);
    setTimeout(()=>  serviceTape1.classList.add('hidden'), 26500);
    setTimeout(()=>  serviceTape2.classList.add('hidden'), 26750);
    setTimeout(()=>  serviceTape3.classList.add('hidden'), 27000);
    setTimeout(()=>  serviceList.classList.add('bg-white'), 27000);
    setTimeout(()=>  serviceList.classList.remove('bg-amber-50'), 27000);
    setTimeout(()=>  serviceList.classList.add('border-gray-100'), 27000);
    setTimeout(()=>  serviceList.classList.add('rounded'), 27000);
    setTimeout(()=>  serviceList.classList.add('border-8'), 27000);
    setTimeout(()=>  serviceList.classList.add('font-salsa'), 28000);
    setTimeout(()=>  serviceList.classList.add('text-[25px]'), 28000);
    setTimeout(()=>  serviceList.classList.remove('font-caveat'), 28000);
    setTimeout(()=>  serviceList.classList.remove('text-[30px]'), 28000);
    setTimeout(()=>  serviceList.classList.add('shadow-md'), 29000);    
    setTimeout(()=>  serviceList.classList.add('shadow-gray-700'), 29000);
}